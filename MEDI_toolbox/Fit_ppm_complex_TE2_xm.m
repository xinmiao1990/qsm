...
function [p1, dp1, relres, p0, iter]=Fit_ppm_complex_TE2_xm(M,TE)
...
p0=reshape(p0,s0(1:L_s0-1))*(TE(2)-TE(1));%we need to convert to [-pi pi] for the next step's phase unwrapping
